...
$("#ardoraMain").append("<div id='"+imaN+"' class='photoMG'><img src='GALERIA_DE_IMAGEN_resources/media/imaMG/" + fileIma[num-1] + "'/></div>");
...
$("#upN").focus(function(e){$(this).css("color","#0000FF")});
...
$("#" + nextN).focus(function(e){$(this).css("color","#0000FF")});
...
$("#" + prevN).focus(function(e){$(this).css("color","#0000FF")});
...
$("#" + titN).focus(function(e){$(this).css("color","#0000FF")});
...
$("#"+imaN).append("<img src='GALERIA_DE_IMAGEN_resources/media/imaMG/" + fileIma[num-1] + "'/>");
}else{
$("#"+imaN+ " img").remove();
if (conType[num-1]=="0"){
...
$("#txtN").focus(function(e){$(this).css("color","#0000FF")});
...
$("#" + fullN).focus(function(e){$(this).css("color","#0000FF")});
$("#" + fullN).blur(function(e){$(this).css("color","#808080")});
}
function showImaFull(num){
$("#ardoraMain").append("<div id='imaFull'><img alt='"+altIma[num - 1]+"' src='GALERIA_DE_IMAGEN_resources/media/imaFull/f_" + fileIma[num-1].substring(2) + "'/></div>");
cssColors();
...
$("#titF").focus(function(e){$(this).css("color","#0000FF")});
$("#titF").blur(function(e){$(this).css("color","#808080")});
$("#nextF").focus(function(e){$(this).css("color","#0000FF")});
$("#nextF").blur(function(e){$(this).css("color","#808080")});
$("#prevF").focus(function(e){$(this).css("color","#0000FF")});
$("#prevF").blur(function(e){$(this).css("color","#808080")});
$("#txtF").focus(function(e){$(this).css("color","#0000FF")});
...
$("#imaFull").append("<img alt='"+altIma[num-1]+"' src='GALERIA_DE_IMAGEN_resources/media/imaFull/f_"+fileIma[num-1].substring(2)+"'/>");
...
if ($.trim(fileMP3[num-1])){sourceLine=sourceLine+"<source src='GALERIA_DE_IMAGEN_resources/media/"+fileMP3[num-1]+"' type='audio/mp3' />";}
if ($.trim(fileOgg[num-1])) {sourceLine=sourceLine+"<source src='GALERIA_DE_IMAGEN_resources/media/"+fileOgg[num-1]+"' type='audio/ogg' />";}
...
sourceLine=sourceLine+"<source src='GALERIA_DE_IMAGEN_resources/media/"+fileMP3[num-1]+"' type='audio/mp3' />";}
if ($.trim(fileOgg[num-1])) {
sourceLine=sourceLine+"<source src='GALERIA_DE_IMAGEN_resources/media/"+fileOgg[num-1]+"' type='audio/ogg'/>";}
...
$("#musN").focus(function(e){$(this).css("color","#0000FF")});
